...
enum Mission {
    ...
    LV4("map/map_lv4.png",
        ...
        public void init(MainGame game) {
            ...
            Villager villager = (Villager)game.getTribe(Tribe.Faction.VILLAGER);
            villager.spawnSquad(villager.getHeadquarterPosition().toGameCoord(),
                    Unit.UnitClass.WORKER, Unit.UnitClass.WORKER);
        }
    ...
    LV5("map/map_lv5.png",
        ...
        public void update(MainGame game) {
            ...
            if (turn == 500) {
                ...
                game.addNews("힌트: 언젠가 도적이 다시 나타날 것입니다.");
            } else if (turn == 2000) {
    ...
    LV6("map/map_lv6.png",
        ...
        public void update(MainGame game) {
            ...
            if (turn == 500) {
                ...
                game.addNews("힌트: 적의 본부를 점령하면 적은 신규 부대를 만들지 못합니다.");
            }
    ...
    LV8("map/map_lv8.png",
        ...
        public void update(MainGame game) {
            ...
            if (turn == 500) {
                ...
                game.addNews("힌트: 이번 미션은 적의 본부만 점령하면 됩니다!");
            } else if (turn == 2500) {
